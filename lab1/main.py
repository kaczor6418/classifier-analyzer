...
def run_program():
    ...
    for test_leaf in leafs_database.test_leafs:
        test_leaf_point: Point = test_leaf.make_point_from_traits(trait_x_id, trait_y_id)
    ...
    chart_drawer.draw_2d_chart(
        leafs_database.create_points_from_leafs(leafs_database.train_leafs_a),
        leafs_database.create_points_from_leafs(leafs_database.train_leafs_b))
