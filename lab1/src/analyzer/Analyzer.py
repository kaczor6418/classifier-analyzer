...
from src.analyzer.typedDictionaries.AnalyzerConfig import AnalyzerConfig
...
class Analyzer:
    ...
    classified_element_config: ClassifiedElementConfig
    ...
    def create_datatable(self, csv_file_path: str, traits_ids: List[int], classes_config: List[ClassConfig],
